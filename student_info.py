...
root.configure(bg='yellow green')
...
def submit():
    ...
    c.execute("INSERT INTO student_info  VALUES(:f_name,:l_name,:age,:address,:email,:number,:sex,:birthday,:mothers_name,:fathers_name,:emergency_contact)",
            {
                  'f_name':f_name.get(),
                  'l_name':l_name.get(),
                  'age':age.get(),
...
def query():
    conn=sqlite3.connect('C:/Users/jenjen/Desktop/Donn.db')
...
def edit():
    ...
    f_name_editor=Entry(editor,width=30, bg='blue')
    f_name_editor.grid(row=0,column=1,padx=20,pady=(10,0))
    l_name_editor=Entry(editor,width=30, bg='blue')
    l_name_editor.grid(row=1,column=1,padx=20)
    age_editor=Entry(editor,width=30, bg='blue')
    age_editor.grid(row=2,column=1,padx=20)
    address_editor=Entry(editor,width=30, bg='blue')
    address_editor.grid(row=3,column=1,padx=20)
    email_editor=Entry(editor,width=30, bg='blue')
    email_editor.grid(row=4,column=1,padx=20)
    number_editor=Entry(editor,width=30, bg='blue')
    number_editor.grid(row=5,column=1,padx=20)
    sex_editor=Entry(editor,width=30, bg='blue')
    sex_editor.grid(row=6,column=1,padx=20)
    birthday_editor=Entry(editor,width=30, bg='blue')
    birthday_editor.grid(row=7,column=1,padx=20)
    mothers_name_editor=Entry(editor,width=30, bg='blue')
    mothers_name_editor.grid(row=8,column=1,padx=20)
    fathers_name_editor=Entry(editor,width=30, bg='blue')
    fathers_name_editor.grid(row=9,column=1,padx=20)
    emergency_contact_editor=Entry(editor,width=30, bg='blue')
    ...
    save_btn.grid(row=15, column=0,columnspan=2,pady=10,padx=10,ipadx=140) 
...
submit_btn=Button(root,text="Add Record",command=submit, bg='yellow')
submit_btn.grid(row=11,column=1,columnspan=3,pady=10,padx=1,ipadx=100)

query_btn=Button(root,text="Show Records",command=query, bg='yellow')
query_btn.grid(row=12,column=1,columnspan=3,pady=10,padx=1,ipadx=126)

query_btn=Button(root, text="Delete Record", command=delete, bg='yellow')
query_btn.grid(row=17, column=1, columnspan=3, pady=10, padx=10, ipadx=125)

update_btn=Button(root,text="Edit Record",command=edit, bg='yellow')
update_btn.grid(row=13,column=1,columnspan=3,pady=10,padx=1,ipadx=133)
